...
date: 2021-07-14T00:25:10+05:30
description: This is a collection of all the possible markdowns and features available in the theming engine.
menu:
  sidebar:
    name: Sample Markdown Snippet
    identifier: sample
    # parent: category
    weight: 1
hero: hero.jpg
...
- Set custom hero image, and post author.
- Various Image tags and their functionalities including the short-code and partial codes intended.
- Enabling table of contents.
- Various forms of markdown content rendering, along with various tags and embedding features.
- Rendering of mathematical formulaes, and emojis.
...
{{< img src="/posts/sample/hero.jpg" title="A boat at the sea" >}}

{{< vs 3 >}}

#### A sample image with `height` and `width` attributes.

{{< img src="/posts/sample/hero.jpg" height="400" width="600" title="A boat at the sea" >}}

{{< vs 3 >}}

#### A center aligned image with `height` and `width` attributes.

{{< img src="/posts/sample/hero.jpg" height="400" width="600" align="center" title="A boat at the sea" >}}

{{< vs 3 >}}

#### A image with `float` attribute.

{{< img src="/posts/sample/hero.jpg" height="200" width="500" float="right" title="A boat at the sea" >}}
